      ...
      <div className="bg-sable-30/50 py-12 md:py-16">
        <div className="container mx-auto px-4">
          ...
          <PartnerSection 
            ...
            imageOnRight={false}
            imageSrc="https://cote-sud.immo/wp-content/uploads/2025/05/Design-sans-titre-5.png"
          >
            <p className="mb-4">
          ...
          <PartnerSection 
            ...
            imageOnRight={true}
            imageSrc="https://cote-sud.immo/wp-content/uploads/2025/05/Design-sans-titre-7.png"
          >
            <p className="mb-4">
          ...
          <PartnerSection 
            ...
            imageOnRight={false}
            imageSrc="https://cote-sud.immo/wp-content/uploads/2025/05/Design-sans-titre-6.png"
          >
            <p className="mb-4">
          ...
          <PartnerSection 
            ...
            imageOnRight={true}
            imageSrc="https://cote-sud.immo/wp-content/uploads/2025/05/Design-sans-titre-8.png"
          >
            <p className="mb-4">
          ...
          <PartnerSection 
            ...
            imageOnRight={false}
            imageSrc="https://cote-sud.immo/wp-content/uploads/2025/05/Design-sans-titre-9.png"
          >
            <p className="mb-4">
